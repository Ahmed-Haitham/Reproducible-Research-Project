...
class TrainXGB:
    ...
    def train_model(self):
        ...
        model = XGBRegressor(eval_metric='rmse', objective="reg:squarederror", seed=self.seed)
        ...
        best_model = XGBRegressor(**best_params,eval_metric='rmse', objective="reg:squarederror", seed=self.seed)
